...
BOT_NAME = 'scrapyFinal3'

SPIDER_MODULES = ['scrapyFinal3.spiders']
NEWSPIDER_MODULE = 'scrapyFinal3.spiders'
...
# DOWNLOADER_MIDDLEWARES = {
#    'scrapyFinal1.middlewares.Scrapyfinal1DownloaderMiddleware': 543,
# }
...
# 숫자가 작을 수록 우선순위 상위
ITEM_PIPELINES = {
    'scrapyFinal3.pipelines.Scrapyfinal1Pipeline': 300,
}
